...
export const MainMenusGradientCard = ({
  ...
  return (
    <div
      className="group relative transform-gpu overflow-hidden bg-white/10 p-2 transition-transform hover:scale-[1.01] active:scale-90"
      ref={parentRef}
    >
      {withArrow && (
      ...
      <div
        className={cn(
          "absolute -translate-x-1/2 -translate-y-1/2 transition-transform duration-500 group-hover:scale-[3]",
